...
export const FeaturedProducts = () => {
	...
	return (
		<div id="controls-carousel" className="relative rounded-t-xl px-10 bg-gray-900/30" data-carousel="static">
					...
					<div className="grid  sm:grid-cols-2 xl:px-20 items-center sm:mx-10 lg:px-30 py-10">
						<div className="flex flex-col gap-2 sm:gap-10 justify-center text-center">
							...
							<div className="inline-flex text-center gap-6 mx-auto">
								<h3 className="text-white  ss:text-[72px] text-[52px] leading-[75px]	">Colombia</h3>
							</div>
						...
						<div className="flex flex-col min-h-3/4  items-center align-middle justify-center">
							<Image src={mapa} alt="" width={400} height={400} />
						</div>
					</div>
				</div>
				<div
